...
import io.github.mandarine3ds.mandarine.utils.FileUtil.getFilename

class CiaInstallWorker(
    val context: Context,
    params: WorkerParameters
) : Worker(context, params) {
    private val GROUP_KEY_CIA_INSTALL_STATUS = "io.github.mandarine3ds.mandarine.CIA_INSTALL_STATUS"
