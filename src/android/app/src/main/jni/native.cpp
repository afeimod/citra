...
void JNICALL Java_io_github_mandarine3ds_mandarine_NativeLibrary_initializeGpuDriver(
...
jobjectArray Java_io_github_mandarine3ds_mandarine_NativeLibrary_getInstalledGamePaths(
...
jboolean Java_io_github_mandarine3ds_mandarine_NativeLibrary_onGamePadMoveEvent(
    [[maybe_unused]] JNIEnv* env, [[maybe_unused]] jobject obj, [[maybe_unused]] jstring j_device,
    jint axis, jfloat x, jfloat y) {
    // Clamp joystick movement to supported minimum and maximum
    // Mandarine uses an inverted y axis sent by the frontend
...
jboolean Java_io_github_mandarine3ds_mandarine_NativeLibrary_onGamePadAxisEvent(
    [[maybe_unused]] JNIEnv* env, [[maybe_unused]] jobject obj, [[maybe_unused]] jstring j_device,
...
jobjectArray Java_io_github_mandarine3ds_mandarine_NativeLibrary_getSavestateInfo(
    JNIEnv* env, [[maybe_unused]] jobject obj) {
